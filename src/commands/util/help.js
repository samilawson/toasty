...
const disambiguation = util.disambiguation;
	...
	async run(msg, args) {
		...
		if(args.command && !showAll) {
          ...
          ${oneLine`
            ...
            There is an **expense to run this bot**, donations are **much** appreciated. Please donate here: **http://toastythebot.tk/donate**
